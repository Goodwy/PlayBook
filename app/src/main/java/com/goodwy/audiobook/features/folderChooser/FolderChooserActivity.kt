...
import com.goodwy.audiobook.features.folderChooser.FolderChooserActivity.Companion.newInstanceIntent
import com.goodwy.audiobook.misc.MultiLineSpinnerAdapter
import com.goodwy.audiobook.misc.PermissionHelper
import com.goodwy.audiobook.misc.Permissions
import com.goodwy.audiobook.misc.colorFromAttr
import com.goodwy.audiobook.misc.itemSelections
import com.goodwy.audiobook.mvp.RxBaseActivity
...
class FolderChooserActivity : RxBaseActivity<FolderChooserView, FolderChooserPresenter>(),
  ...
  override fun setUpButtonEnabled(upEnabled: Boolean) {
    ...
    val upIcon = if (upEnabled) getDrawable(R.drawable.ic_folder_up)!! else null
