...
import com.goodwy.audiobooklite.databinding.MergeRewindStyleRoundedBinding
...
class RewindStyleRoundedView : ConstraintLayout {

  private val binding = MergeRewindStyleRoundedBinding.inflate(layoutInflater(), this)
