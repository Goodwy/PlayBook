...
import com.goodwy.audiobooklite.databinding.MergePlayStyleClassicBinding
...
class PlayStyleClassicView : ConstraintLayout {

  private val binding = MergePlayStyleClassicBinding.inflate(layoutInflater(), this)
