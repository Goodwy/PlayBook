...
import com.goodwy.audiobooklite.databinding.MergeMiniPlayerButtonBinding
...
class MiniPlayerButtonView : ConstraintLayout {

  private val binding = MergeMiniPlayerButtonBinding.inflate(layoutInflater(), this)
