...
object PrefKeys {
  ...
  const val SORTING_CURRENT = "SORTING_CURRENT"
  const val SORTING_NOT_STARTED = "SORTING_NOT_STARTED"
  const val SORTING_FINISHED = "SORTING_FINISHED"
  ...
  const val USE_ANIMATED_MARQUEE = "USE_ANIMATED_MARQUEE"
