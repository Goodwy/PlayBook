...
class VoicePlayerTest {
  ...
  private val player = VoicePlayer(
    ...
    seekTimeRewindPref = seekTimePref,
  ...
  fun `seekToNext does not clip`() = scope.runTest {
    setMediaItems(
      listOf(
        chapter(
          ChapterMark(startMs = 0, endMs = 19_999, name = null, cover = null),
          ChapterMark(startMs = 20_000, endMs = 30_000, name = null, cover = null),
        ),
        chapter(
          ChapterMark(startMs = 0, endMs = 19_999, name = null, cover = null),
          ChapterMark(startMs = 20_000, endMs = 30_000, name = null, cover = null),
  ...
  fun `seekToPrevious does not clip`() = scope.runTest {
    setMediaItems(
      listOf(
        chapter(
          ChapterMark(startMs = 0, endMs = 4_999, name = null, cover = null),
          ChapterMark(startMs = 5_000, endMs = 12_000, name = null, cover = null),
        ),
        chapter(
          ChapterMark(startMs = 0, endMs = 4_999, name = null, cover = null),
          ChapterMark(startMs = 5_000, endMs = 12_001, name = null, cover = null),
        ),
      ),
    )
  ...
  fun `forceSeekToNext jumps to chapters`() = scope.runTest {
    setMediaItems(
      listOf(
        chapter(
          ChapterMark(startMs = 0, endMs = 11_999, name = null, cover = null),
          ChapterMark(startMs = 12_000, endMs = 20_000, name = null, cover = null),
        ),
        chapter(
          ChapterMark(startMs = 0, endMs = 11_999, name = null, cover = null),
          ChapterMark(startMs = 12_000, endMs = 20_000, name = null, cover = null),
