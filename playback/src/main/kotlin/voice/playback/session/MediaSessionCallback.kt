  ...
  override fun onCustomAction(action: String?, extras: Bundle?) {
    ...
    scope.launch {
      when (action) {
        ...
        REPEAT_ACTION -> {
          val repeat = extras!!.getInt(REPEAT_EXTRA)
        ...
        USE_CHAPTER_COVER_ACTION-> {
          val use = extras!!.getBoolean(USE_CHAPTER_COVER_EXTRA)
          player.setUseChapterCover(use)
        }
        SET_POSITION_ACTION -> {
...
private const val USE_CHAPTER_COVER_ACTION = "useChapterCover"
private const val USE_CHAPTER_COVER_EXTRA = "$USE_CHAPTER_COVER_ACTION#value"

fun TransportControls.useChapterCover(use: Boolean) = sendCustomAction(USE_CHAPTER_COVER_ACTION) {
  putBoolean(USE_CHAPTER_COVER_EXTRA, use)
}
